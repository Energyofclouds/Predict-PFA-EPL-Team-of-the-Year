...
X = df_MD.iloc[:,1:(len(df_MD.columns)-1)]
y= df_MD.iloc[:,(len(df_MD.columns)-1)]
...
# PCA사용해서 독립변수 줄여서 돌려봤음. 근데 굳이 안해도 될듯?

"""
from sklearn.decomposition import PCA
pca = PCA(n_components=10)
W5 = pca.fit_transform(X)
knn_W5 = KNeighborsClassifier(n_neighbors = 3)
knn_W5.fit(W5,y)
conf_knn_W5 = confusion_matrix(y_true = y, y_pred = knn_W5.predict(W5))



print(conf_knn_W5)
print(knn_W5.score(W5,y))
